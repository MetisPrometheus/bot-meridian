...
class StatusTests(unittest.TestCase):
    def test_winter_and_summer_offsets(self):
        self.assertEqual(timezone_status(datetime(2026, 1, 1, 12, tzinfo=timezone.utc)), "06:00 | 13:00 | 20:00")
        self.assertEqual(timezone_status(datetime(2026, 7, 1, 12, tzinfo=timezone.utc)), "07:00 | 14:00 | 20:00")
...
class LifecycleTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_presence_is_sent_after_ready(self):
        ...
        with patch('bot.timezone_status', return_value='12:00 | 19:00 | 01:00'):
            await bot.ticker()
        ...
        self.assertEqual(kwargs['activity'].name, '12:00 | 19:00 | 01:00')
        await bot.close()
