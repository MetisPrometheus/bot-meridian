...
A personal Discord bot I use that displays multiple time zones in its status, updating every minute.
Useful when working with people from vastly different timezones.
